...
AssertEqual(true, UpdateManager.IsVersionNewer("v0.5.0", "0.4.1"), "newer release version");
AssertEqual(false, UpdateManager.IsVersionNewer("v0.4.1", "0.4.1"), "same release version");
AssertEqual(false, UpdateManager.IsVersionNewer("not-a-version", "0.4.1"), "invalid release version");
